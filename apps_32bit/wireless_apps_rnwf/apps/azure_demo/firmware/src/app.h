...
//#define AZURE_DEVICE_ID         SYS_RNWF_MQTT_CLIENT_ID
//#define AZURE_SCOPE_ID          SYS_RNWF_MQTT_SCOPE_ID
//#define AZURE_DPS_ENABLE        1

#define AZURE_PUB_TELEMETRY     "devices/"SYS_RNWF_MQTT_CLIENT_ID"/messages/events/"
